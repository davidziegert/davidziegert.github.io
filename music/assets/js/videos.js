...
const gallery = document.querySelector(".box-videos");

videos.forEach((item) => {
  const tag = document.createElement("div");
  tag.classList.add("video");
  tag.innerHTML = `<a href="${item.link}" target="_blank" rel="noopener noreferrer"><figure><img src="${item.img}" alt="image loading" loading="lazy"/><figcaption>${item.title}</figcaption></figure></a>`;
